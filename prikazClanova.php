        ...
        <tbody id="prikazBody">
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><?php echo $sviClanovi[$i]->clanarina . " RSD" ?></td>
                    <td><a href="brisanjeClana.php?clanId=<?php echo $sviClanovi[$i]->clanId ?>"><button class="btn btn-danger" id="obrisi-button" value="<?php echo $sviClanovi[$i]->clanId; ?>">Obriši</button></a>
